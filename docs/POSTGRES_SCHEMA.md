# PostgreSQL Schema Design for AlphaSignal

## Overview
This document outlines the database schema for migrating AlphaSignal from SQLite to PostgreSQL. The migration aims to support better concurrency, richer data types (JSONB), and scalability.
